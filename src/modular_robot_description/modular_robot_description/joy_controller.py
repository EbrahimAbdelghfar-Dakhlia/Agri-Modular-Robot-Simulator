...
class Commander(Node):
    ...
    def timer_callback(self):
        ...
        # pivot turn
            ...
            self.pos[0] = math.atan(self.wheel_base/self.new_steering_track)
            self.pos[1] = -math.atan(self.wheel_base/self.new_steering_track)
            self.pos[2] = -math.atan(self.wheel_base/self.new_steering_track)
            self.pos[3] = math.atan(self.wheel_base/self.new_steering_track)
        ...
        print(f'Publishing pos: {self.pos}, vel: {self.vel}, extending_length: {extending_length}, elevating_length: {elevating_length}',mode_selection )
