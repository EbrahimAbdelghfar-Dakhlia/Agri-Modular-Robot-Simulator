...
class FindEsp32:
    def __init__(self):
        ...
        self.context = self.pyudev.Context()
    ...
    def install_pyudev(self):
        try:
            ...
            print("pyudev not found. Attempting to install...")
            try:
                subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'pyudev'])
                print("pyudev installed successfully.")
                import pyudev
                return pyudev
            except subprocess.CalledProcessError:
                print("Failed to install pyudev. Please install it manually and run the script again.")
                sys.exit(1)
            except ImportError:
                print("Failed to import pyudev after installation. Please check your installation.")
                sys.exit(1)
