...
namespace controller
{
    class MPPI : public rclcpp::Node// MPPI execution (dependent on ROS)
    {
        ...
        private:
            ...
            rclcpp::Publisher<rviz_2d_overlay_msgs::msg::OverlayText>::SharedPtr pub_mppi_overlay_text_;
            ...
            void refPathCallback(const nav_msgs::msg::Path::ConstPtr& msg);
            ...
            void collisionCostmapCallback(const nav_msgs::msg::OccupancyGrid::ConstPtr& msg);
            ...
            void distanceErrorMapCallback(const grid_map_msgs::msg::GridMap::ConstPtr& msg);
            ...
            void refYawMapCallback(const grid_map_msgs::msg::GridMap::ConstPtr& msg);
